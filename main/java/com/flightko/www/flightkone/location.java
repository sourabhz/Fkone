...
public class location extends AppCompatActivity {
    ...
    //My Home Distance
    private static final double HOME_LONGITUDE = 80.262583d;
    private static final double HOME_LATITUDE = 13.05825d;
    ...
    LocationListener listener = new LocationListener() {
        ...
        public void onProviderEnabled(String provider) {
            locationText.setText("Location Provider is Enabled !!");
        }
    };
        ...
        AsyncTaskCompat.executeParallel(new AsyncTask<Void, Void, Boolean>() {
            ...
            protected void onPostExecute(Boolean aBoolean) {
                super.onPostExecute(aBoolean);
                    Toast.makeText(location.this,aBoolean ?"Server Request Sent !!":"No Request Sent !!",Toast.LENGTH_SHORT).show();
            }
        });
